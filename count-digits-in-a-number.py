...
Count digits from behind by removing each digit by using integer division with 10,
until the number goes zero. This operator removes the trailing decimal part.
...
'''
Algorithm explanation
Simply calculate the expression int(log10(n)) + 1 = num of digits
'''
def optimal():
    n = int(input(""))
